...
$cfg['blowfish_secret']					= '?Ba*$D5b~>oeF.}}o@y=}<JvLQE8Iod*' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://www.thing2inter.net/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_MEAjNrqCBonHhiKf34LvJDx/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
