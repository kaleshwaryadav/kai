<?php
/*
 * Template Name: Small Image Template
 */
...
if(!empty($_REQUEST['cloning'])=='done'){
    ...
    $secon_desc  = get_field('asset_full_description','option');
    ...
    $download_link = get_field('asset_download','option');
...
<div class="template-wrapper">
	<section>
		<div class="container">
			...
			<form method="post" id="small-template" class="template-submit-form" enctype="multipart/form-data" >
            
            <input type="hidden" name="action" value="small_template">
                <input type="hidden" name="template_value" value="small-business">
                ...
                <p class="heading_msg"><?php if(!empty($heading_msg)){ echo $heading_msg;} ?></p>
					...
					<div class="col-md-6 col-sm-12 col-xs-12 no-padding">
                        <div class="txt-title">
                        <input class="w-75 form-control" type="text" placeholder="<?php echo $assettitle; ?>" id="temp_title" name="temp_title"  value="<?php if(!empty($asset_title)){ echo $asset_title; } ?>" required>
                        </div>
                        <div class="txt-title">
                        <input class="w-75 form-control" type="text" placeholder="<?php echo $assetsName; ?>" id="asset_name" name="asset_name" value="<?php echo $asset_name; ?>" required >
                        </div>
                        <div class="txt-title">
                      <input class="w-75 form-control" type="text" placeholder="<?php echo $assetsShortDescription; ?>" id="short_desc" name="short_desc" value="<?php echo $assert_desc; ?>" maxlength="150" required>
                        </div>                        
                        ...
                        <div class="txt-editor">
                        <p style="color:#9a9494; font-size: 16px; position: relative; top:23px;">
                       ...
                       <div class="txt-editor">
                        ...
                        <input type="file" name="downloadfile" id="downloadfile" value="<?php echo $download_link['url']; ?>" onchange="return fileValidation();">
                          <!--   <label for="upload-1">
                        ...
                        <div class="save-draft-text">
                            ...
                            <button type="submit" class="btn custom-bt" style="display: none;">
                           <img src="<?php bloginfo('template_url') ?>/assets/images/load-more.gif" class="loading-image" id="loading-image" style="display: none;"></i><?php echo $Publish; ?></button>                            
						</div>
...
$('#small-template').submit(function() {
...
function fileValidation(){
     ...
     if(!allowedExtensions.exec(filePath)){
        alert('Please upload file extensions .jpeg/.jpg/.png/.pdf only.');
        fileInput.value = '';
        return false;
    }
   }
