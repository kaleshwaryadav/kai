<?php
/*
 * Template Name: Product Detail Technical
 */
...
<div class="template-wrapper">
							...
							<div class="item">            
								<div class="clearfix" >
									<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
										<li data-thumb="<?php bloginfo('template_url') ?>/assets/images/prod_dtl_tech.jpg"> 
											<img src="<?php bloginfo('template_url') ?>/assets/images/prod_dtl_tech.jpg"  alt="slider_img" />
										</li>
										<li data-thumb="<?php bloginfo('template_url') ?>/assets/images/prod_dtl_tech.jpg"> 
											<img src="<?php bloginfo('template_url') ?>/assets/images/prod_dtl_tech.jpg"  alt="slider_img" />
										</li>
					...
					<div class="col-sm-6">
						<div class="product_dtl">
							...
							<div class="features">
								...
								<div class="btn_set"><a href="#" class="btn  ">download pdf</a><a href="#" class="btn btn_bdr ">Order</a></div>
							</div>
    ...
    <!-- <div class="col-sm-12">
    		<div class="txt-editor">
							<textarea id="area3" style="min-height:293px; width:95%;"></textarea>
						</div>
					</div> -->
				</div>
			</div>

			<div class="row no-margin extended">
				<h3>Detail</h3>
				<div class="col-md-5 col-sm-5 col-xs-12 no-padding">
					<div class="uploader-user">
						...
						<div class="details_owner ">
							...
							<!-- <input type="file" style="display:none" id="upload-2" multiple="">
							<div id="upload-2" class="drop-area-2">
								<span class="btn">UPLOAD PHOTO</span>
							</div> -->
						</div>
					</div>
			...
			<div class="container">
				<div class="activity-list" id="target">
					<ul class="list-unstyled list-inline text-center">
						<li>
							<a href="#" data-toggle="modal" data-target="#share_product">
						...
						<li>
							<a href="#" data-toggle="modal" data-target="#reminder_popup">
