 ...
 */
function t2i_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter T2i default saturation level.
	 *
	 * @since T2i 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 't2i_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.t2i-front-page) .entry-title,
...
.colors-custom .t2i-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.t2i-front-page .panel-content .recent-posts article,
...
.colors-custom.t2i-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 't2i_custom_colors_css', $css, $hue, $saturation );
}
