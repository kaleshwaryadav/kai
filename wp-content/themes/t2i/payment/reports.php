             ...
             <div class="inside">
                <div class="main">
                 <?php $TemplateList = get_terms( 'asset-detail', array(
                   ...
                   ?>
                   <ul>
                     <li>1) Amount of Template <a href="<?php echo site_url(); ?>/wp-admin/edit.php?post_type=assets&page=report_asset&action=totalamt_tmp&lang=en"><?php echo count($TemplateList); ?> View</a></li>
