...
if(!empty($_REQUEST['cloning'])=='done'){
 ...
 $lanCode = ICL_LANGUAGE_CODE;
    if($lanCode=='en'){
       ...
       $AssetShortDescription = "Asset Short Description";
    ...
    else
    {
     ...
     $AssetShortDescription = "Asset-Kurzbeschreibung";
                ...
                <p class="heading_msg"><?php if(!empty($heading_msg)){ echo $heading_msg;} ?></p>
                  <div class="col-md-6 col-sm-12 col-xs-12 no-padding">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 no-padding">
                        ...
                        <div class="txt-title">
                        <input class="w-75 form-control" type="text" placeholder="<?php echo $assettitle; ?>" id="temp_title" name="temp_title" value="<?= $_POST['temp_title']=="" ? "" : $_POST['temp_title'];?>">
                        </div>
                        <div class="txt-title">
                        ...
                        <div class="txt-title">
                      <input class="w-75 form-control" type="text" placeholder="<?php echo $AssetShortDescription; ?>" id="short_desc" maxlength="150" name="short_desc" value="<?php echo $assert_desc; ?>">
                        </div>                        
                        ...
                        <div class="publish-sec">
                            <input class="w-75 form-control notdecimal" type="text" placeholder="<?php echo $Price; ?>" id="temp_price" name="temp_price" value="<?php echo $price; ?>">
                                                      
                        </div>

                        <div class="publish-sec">
                            <div class="save-draft-text">
                             <span><?php echo $SaveasDraft; ?> :</span>
                            </div>
...
/*$(".notdecimal").on("keypress keyup blur paste", function(event) {
    var that = this;
    //paste event 
    if (event.type === "paste") {
        setTimeout(function() {
