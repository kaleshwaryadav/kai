...
$asset_obj = get_the_terms( $astid, 'asset-detail' );
$template_name = $asset_obj[0]->slug;
//echo $template_name;
...
$temp_description =  get_field('temp_description', $astid, true);
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <input class="w-75 form-control" type="text" placeholder="<?php echo $ShortDescription; ?>" id="short_desc" name="short_desc" value="<?php echo $assert_desc; ?>">
                        ...
                        <div class="txt-editor">
                           <?php wp_editor( $temp_description, 'temp_description', array( 'theme_advanced_buttons1' => 'bold, italic, ul, pH, pH_min, p', "media_buttons" => false, "textarea_rows" => 8, "tabindex" => 4 ) ); ?>
                        </div>
                         <?php } ?>
                        <?php if($secon_desc!=""){ ?>
                        <div class="txt-editor">
                        ...
                        <?php 
                        if($template_name=="image-template"){?>
                           <div class="publish-sec">
                            <input class="w-75 form-control" type="text" placeholder="<?php echo $Price;?>" id="temp_price" name="temp_price" value="<?php echo $price; ?>">
                            </div> 
                        <?php
                        }
                        if(!empty($link)){?>
                         ...
                         <div class="publish-sec">
                            <div class="save-draft-text">
                             ...
                             <div class="publish-sec-divide">
                                <?php
                                $term_obj = get_the_terms( $astid, 'category' );
                                //print_r($term_obj);
