    ...
    <div>
        <div class="container">
            ...
            <div class="product_details ">
                ...
                wp_editor(  $temp_description, 'temp_description', array( 'theme_advanced_buttons1' => false, "media_buttons" => false,"textarea_rows" => 8, "tabindex" => 4 ) );
               }
                        ...
                        <div class="row">
                            ...
                            <?php  switch($visible): 
                                   ...
                                   <div class="form-group group">
                                    ...
                                    <div class=" slider_cont text-center">
                                    <button class="private_acesslevel" type="button" class="btn" name="contact_query"><?php echo $save; ?><span></span>
                                    </button>
